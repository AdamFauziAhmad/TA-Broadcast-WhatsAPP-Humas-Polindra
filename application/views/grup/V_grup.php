                     ...
                     <form action="<?php echo site_url('grup/tambah_grup'); ?>" method="post">
                         <div class="card-body">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-12">
                                     <select class="select2" data-live-search="true" name="kontak[]" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
                                         <?php foreach ($kontak->result() as $row) : ?>
                                             <option value="<?php echo $row->id_kontak; ?>"><?php echo $row->nama_kontak . " - " . $row->tahun_masuk . " - " . $row->kelas; ?> </option>
                                         <?php endforeach; ?>
