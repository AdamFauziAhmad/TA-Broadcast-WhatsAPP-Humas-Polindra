                 ...
                 <div class="col-12">
                     <div class="card">
                         <div class="card-header">
                             ...
                             <button form="kontak-checkbox" type="submit" class="btn btn-block bg-gradient-secondary" style="width: 20%; display: inline;">Buat Pesan Broadcast</button>
                                         ...
                                         <?php
                                            ...
                                            ?>
                                             <tr>
                                                 ...
                                                 <td><input name="id_kontak[]" value="<?php echo $row->id_kontak ?>" class="form-check-input" type="checkbox"><?php echo $row->nama_kontak; ?></td>
